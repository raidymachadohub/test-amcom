...
namespace Questao1 {
    class Program {
        static void Main(string[] args) {
            ...
            Console.WriteLine(
                $"Conta {conta.conta.ToString()}, Titular: {conta.titular}, Saldo: {conta.depositoInicial.ToString()}");
            ...
            Console.WriteLine(
                $"Conta {conta.conta.ToString()}, Titular: {conta.titular}, Saldo: {conta.SaldoAtualizado().ToString()}");
            ...
            Console.WriteLine("Dados da conta atualizados:");
            Console.WriteLine(
                $"Conta {conta.conta.ToString()}, Titular: {conta.titular}, Saldo: {conta.SaldoComTaxa().ToString()}");
